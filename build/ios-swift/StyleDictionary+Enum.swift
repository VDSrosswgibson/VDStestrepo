...
public enum StyleDictionaryEnum {
    ...
    public static let spacing100 = 2px
    public static let spacing1000 = 48px
    ...
    public static let spacing700 = 24px
    public static let spacing800 = 32px
    public static let spacing900 = 40px
}
